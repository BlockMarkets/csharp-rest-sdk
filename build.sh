...
${nuget_cmd} install src/BlockMarkets.Rest/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/BlockMarkets.Rest.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/BlockMarkets.Rest.dll \
-recurse:'src/BlockMarkets.Rest/*.cs' \
-doc:bin/BlockMarkets.Rest.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/BlockMarkets.Rest.dll was created successfully"
fi
